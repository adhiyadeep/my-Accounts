...
export class AddExpensePage {
  ...
  addExpenseData() {
    ...
    if (this.data.date == "") {
    ...
    else if (this.data.givento == "") {
      this.commonProvider.toastMessage("Please Enter Given to");
    }
      ...
      this.dataProvider.addExpense(this.data).subscribe(res => {
